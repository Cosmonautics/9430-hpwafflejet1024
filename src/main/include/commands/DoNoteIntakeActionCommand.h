...
class DoNoteIntakeActionCommand : public frc2::CommandHelper<frc2::Command, DoNoteIntakeActionCommand> {
public:
    DoNoteIntakeActionCommand(Conveyor* conveyorSubsystem, Shooter* shooterSubsystem, Intake* intakeSubsystem); // Put in all relevant subsystems
